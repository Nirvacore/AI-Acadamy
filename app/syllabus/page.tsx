    ...
    <>
      ...
      <section className="prose">
        ...
        <ul>
          ...
          <li>พาชิ้นงานสื่อครบวงจรใน Nirva Media Lab โดยคนตรวจก่อนขอคิว และเธอห้ามเผยแพร่แทน</li>
        ...
        <p>
          ...
          แล้วปิดท้ายด้วย <TrackedLink href="/media">Nirva Media Lab</TrackedLink> เป็นแล็บประยุกต์ ไม่ใช่แทร็กบริษัทตัวที่ห้า
