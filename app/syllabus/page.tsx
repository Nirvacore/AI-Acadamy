    ...
    <>
      <header className="lesson-head">
        ...
        <p className="lede">
          ...
          เนื้อหาต้นฉบับไทย เรียนจบใน Nirva Academy โดยไม่คัดลอกบทอังกฤษของบริษัทอื่น
        </p>
      </header>
      ...
      <section className="prose">
        ...
        <ul>
          ...
          <li>พาชิ้นงานสื่อครบวงจรในกรณีศึกษา Nirva Media โดยคนตรวจก่อนขอคิว และเธอห้ามเผยแพร่แทน</li>
        ...
        <p>
          ...
          แล้วปิดท้ายด้วยเส้นทางสามตอนใน <TrackedLink href="/media">กรณีศึกษาสื่อ</TrackedLink>
          ซึ่งใช้ผลิตภัณฑ์ Nirva Media เป็นกรณีศึกษา ไม่ใช่โมดูลใน Academy
        ...
        <p>
          ...
          ของแถมในดิฟไม่ยอมรับ หลักฐานต้องเปิดตามได้ แล็บสื่อห้ามให้เธอเผยแพร่แทนคน
        </p>
        <h2>แผนเวลา</h2>
        <ul>
