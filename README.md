...
- หน้าแรกเป็นพอร์ทัลเรียน: ความคืบหน้า แผน ๗ วัน/๔ สัปดาห์ และงานวันนี้
- กด `⌘K` / `Ctrl+K` เพื่อค้นบท แล็บ สคริปต์ และศัพท์
- แต่ละบทมีผลลัพธ์เมื่อจบ เวลาโดยประมาณ สอบสั้น และคำเตือนถ้าข้ามลำดับ
- อภิธานศัพท์มีบัตรคำแบบ Leitner · หลักสูตรและเกียรติบัตรอยู่ที่ `/syllabus` `/certificate`
